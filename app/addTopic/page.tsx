...
export default function AddTopic() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="grid w-full w=[750] items-center gap-1.5">
      <Input onChange={(e) => setTitle(e.target.value)} value={title} type="text" placeholder="Topic Title" className="bg-violet-200/10 placeholder-zinc-700" />
      <Input onChange={(e) => setDescription(e.target.value)} value={description} type="text" placeholder="Topic Description" className="bg-violet-200/10 placeholder-zinc-700" />
      <div>
